// pages/members/children/edit/index.js
const { addMember, getMember, updateMember, deleteMember } = require('../../../../services/members')
...
Page({
  ...
  async loadMember() {
    try {
      const member = await getMember(this.data.id)
      this.setData({
        form: {
          name: member.name,
